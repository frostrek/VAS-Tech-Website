...
const { FormData } = require('formdata-node'); // Node.js doesn't have native FormData in older versions, but let's try manual boundary construction to be dependency-free.
