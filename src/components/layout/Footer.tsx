          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-6">
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <a href="https://wa.me/12894384445" target="_blank" rel="noopener noreferrer" className={`social-icon group w-8 h-8 rounded-full flex items-center justify-center transition-colors ${theme === 'dark' ? 'bg-dark-card text-dark-accent hover:bg-dark-accent hover:text-white' : 'bg-[#fdfbf7] text-[#B07552] hover:bg-[#B07552] hover:text-white'}`}><img src="/whatsapp.png" alt="WhatsApp" className="w-5 h-5 object-contain transition-all group-hover:brightness-0 group-hover:invert" /></a>
                <a href="mailto:vastechconsulting@yahoo.com" className={`social-icon w-8 h-8 rounded-full flex items-center justify-center transition-colors ${theme === 'dark' ? 'bg-dark-card text-dark-accent hover:bg-dark-accent hover:text-white' : 'bg-[#fdfbf7] text-[#B07552] hover:bg-[#B07552] hover:text-white'}`}><Mail size={16} /></a>
              </div>
            </div>
